  ...
  return (
    <div className="undergraduate-menu menu" id='ug-menu' data-aos='zoom-in'>
      <div>
        ...
        <input type="text" placeholder='Please type your Course...' className='input' id='input4' onChange={handleTypedCourse}/>
      ...
      <div>
        ...
        <input type="text" placeholder='Please type your Course Duration...' className='input' id='input5' onChange={handleTypedDuration} />
      ...
      <div>
        ...
        <input type="text" placeholder='Please type your Current Year...' className='input' id='input6' onChange={handleTypedYear} />
